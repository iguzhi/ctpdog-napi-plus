...
class CThostFtdcMdSpiI : public CThostFtdcMdSpi 
{
    ...
    public:
        ...
        virtual void MainOnRspQryMulticastInstrument(CThostFtdcMulticastInstrumentField *pMulticastInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) = 0;
